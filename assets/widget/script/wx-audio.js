var WxAudio = function (i) {
    ...
    return e.m = i, e.c = t, e.d = function (i, t, o) {
        e.o(i, t) || Object.defineProperty(i, t, {configurable: !1, enumerable: !0, get: o})
    }, e.r = function (i) {
    ...
    0: function (i, t, e) {
        ...
        var n = function () {
            ...
            return o(i, [{
                ...
                key: "showLoading", value: function (i) {
                    this.loading = i || !1, this.loading ? this.wxLoading.style.display = "block" : this.wxLoading.style.display = "none"
                }
            }, {
                key: "initAudioEvent", value: function () {
                    var i = this;
                    i.wxAudio.onplaying = function () {
                        var t = new Date;
                        i.isPlaying = !0, i.reduceTBefore = Date.parse(t) - Math.floor(1e3 * i.wxAudio.currentTime), i.wxAudioStateImg.src = "../../../image/stop.png"
                    }, i.wxAudio.onpause = function () {
                        i.isPlaying = !1, i.showLoading(!1), i.wxAudioStateImg.src = "../../../image/startPlay.png"
                        ...
                        i.isDrag = !0;
                        var e = (t || window.event).clientX, o = t.target.offsetLeft;
                        ...
                        i.isDrag = !0;
                        var e = t || window.event, o = e.touches[0].clientX, n = e.target.offsetLeft;
                        ...
                        var e = (t || window.event).layerX, o = i.wxAudioDetail.offsetWidth;
                        i.wxAudio.currentTime = Math.floor(e / o * i.durationT)
                    }
                }
            }, {
                key: "updatePorgress", value: function () {
                ...
                key: "formartTime", value: function (i) {
                    var t = function (i) {
                        return (i = i.toString())[1] ? i : "0" + i
                    }, e = Math.floor(i / 60), o = Math.floor(i % 60);
                    return t(e) + ":" + t(o)
                }
            }]), i
        }();
