...
function VClass(netip, netport, uid, private_token, vclass_token) {
    var socket = io.connect("http://" + netip + ":" + netport + "/vclass");
    this._socket = socket;
    this._uid = uid;
    this._private_token = private_token;
    this._vclass_token = vclass_token;
};
/**
 * 发送给老师
 * @param to_uid
 ...
 * @constructor
 */
VClass.prototype.SendToTeacher = function (to_uid, payload) {
    //学生发送信息给老师 一对一.....
    this._socket.emit('SendToTeacher', {uid: to_uid, payload: payload});
}
/**
 * 加入课堂
 * @constructor
 */
// VClass.prototype.StuJoinClass = function () {
//     this._socket.emit('StudentJoin', ({
//         vclass_token: this._vclass_token,
//         private_token: this._private_token,
//         uid: this._uid
//     }));
// }
 ...
 * @constructor
 */
VClass.prototype.TeacherJoinClass = function () {
    this._socket.emit('TeacherJoin', ({
        device:'app_client',
        vclass_token: this._vclass_token,
        private_token: this._private_token,
        uid: this._uid
 ...
 * @constructor
 */
VClass.prototype.ControlJoinClass = function () {
    this._socket.emit('TeacherJoin', ({
        device:'app_client',
        vclass_token: this._vclass_token,
        private_token: this._private_token,
 ...
 * @param fn
 */
VClass.prototype.onTeacherMessage = function (fn) {
    this._fnOnTeacherMessage = fn;
    var $this = this;
    this._socket.on('TeacherMessageEvent', function (data) {
        $this._fnOnTeacherMessage && $this._fnOnTeacherMessage(data);
    })
}
 ...
 * @param fn
 */
VClass.prototype.onJoinClass = function (fn) {
    this._fnOnJoinClass = fn;
    var $this = this;
    this._socket.on('JoinClassEvent', function (data) {
        $this._fnOnJoinClass && $this._fnOnJoinClass(data);
    })
}
 ...
 * @param fn
 */
VClass.prototype.onControlMessageReply=function(fn){
    this._fnOnControlMessageReply=fn;
    var $this = this;
    this._socket.on('ControlMessageReply', function (data) {
        $this._fnOnControlMessageReply && $this._fnOnControlMessageReply(data);
    })
}
 ...
 * @param fn
 */
VClass.prototype.onTeacherLeaveClass=function (fn) {
    this._fnOnTeacherLeaveClass=fn;
    var $this = this;
    this._socket.on('TeacherLeaveClass', function (data) {
        $this._fnOnTeacherLeaveClass && $this._fnOnTeacherLeaveClass(data);
    })
}
 ...
 * @param fn
 */
VClass.prototype.onDisconnect=function (fn) {
    this._fnOnDisconnect=fn;
    var $this = this;
    this._socket.on('disconnect', function (data) {
        $this._fnOnDisconnect && $this._fnOnDisconnect(data);
    })
}
 ...
 * @param fn
 */
VClass.prototype.on = function (event,fn) {
