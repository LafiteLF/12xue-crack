.class public Landroids/utils/ImageUtils;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroids/utils/ImageUtils;->BITMAP_CONFIG:Landroid/graphics/Bitmap$Config;

    .line 41
    sget-object v0, Landroid/provider/MediaStore$Images$Media;->EXTERNAL_CONTENT_URI:Landroid/net/Uri;

    sput-object v0, Landroids/utils/ImageUtils;->STORAGE_URI:Landroid/net/Uri;
...
.method public static addImage(Landroid/content/ContentResolver;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 53
    invoke-static/range {v3 .. v10}, Landroids/utils/ImageUtils;->addImage(Landroid/content/ContentResolver;Ljava/lang/String;JLandroid/location/Location;Ljava/lang/String;Ljava/lang/String;[I)Landroid/net/Uri;
...
.method private static addImage(Landroid/content/ContentResolver;Ljava/lang/String;JLandroid/location/Location;Ljava/lang/String;Ljava/lang/String;[I)Landroid/net/Uri;
    ...
    .line 82
    :cond_0
    sget-object p1, Landroids/utils/ImageUtils;->STORAGE_URI:Landroid/net/Uri;
...
.method public static final createBitmapFromPath(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    .line 219
    invoke-static {v3, p1}, Landroids/utils/ImageUtils;->computeBitmapSimple(II)I
    ...
    .line 225
    invoke-static {p1, p0, v1}, Landroids/utils/ImageUtils;->rotateBitmapByExif(Landroid/graphics/Bitmap;Ljava/lang/String;Z)Landroid/graphics/Bitmap;
...
.method public static final createBitmapFromPath(Ljava/lang/String;Landroid/content/Context;)Landroid/graphics/Bitmap;
    ...
    .line 195
    invoke-static {p0, v0, p1}, Landroids/utils/ImageUtils;->createBitmapFromPath(Ljava/lang/String;II)Landroid/graphics/Bitmap;
...
.method public static getBitmapFromDrawable(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    .line 305
    sget-object v1, Landroids/utils/ImageUtils;->BITMAP_CONFIG:Landroid/graphics/Bitmap$Config;
    ...
    sget-object v3, Landroids/utils/ImageUtils;->BITMAP_CONFIG:Landroid/graphics/Bitmap$Config;
...
.method public static getVideoThumbnail(Ljava/lang/String;IIILandroids/Image/ImageCache;)Landroid/graphics/Bitmap;
    .locals 2
    ...
    .line 398
    invoke-virtual {p4, v0}, Landroids/Image/ImageCache;->getBitmap(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p4, p0, v0, p1}, Landroids/Image/ImageCache;->save(Landroid/graphics/Bitmap;Ljava/lang/String;Landroid/graphics/Bitmap$CompressFormat;)V
...
.method public static optimizeMaxSizeByView(Landroid/view/View;II)[I
    ...
    .line 353
    invoke-static {p0, v4}, Landroids/utils/ReflectUtil;->getValue(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Landroids/utils/Util;->getScreenWidth(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Landroids/utils/Util;->getScreenHeight(Landroid/content/Context;)I
...
.method public static rotateBitmapByExif(Landroid/graphics/Bitmap;Ljava/lang/String;Z)Landroid/graphics/Bitmap;
    ...
    .line 177
    invoke-static {p1}, Landroids/utils/ImageUtils;->getBitmapExifRotate(Ljava/lang/String;)I
    ...
    .line 180
    invoke-static {p0, p1, p2}, Landroids/utils/ImageUtils;->rotate(Landroid/graphics/Bitmap;IZ)Landroid/graphics/Bitmap;
