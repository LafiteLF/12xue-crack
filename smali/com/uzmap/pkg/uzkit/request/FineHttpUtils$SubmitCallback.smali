.class Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;
...
.method public constructor <init>(Lcom/uzmap/pkg/uzkit/request/Request;Lcom/uzmap/pkg/uzkit/fineHttp/RequestListener;)V
    ...
    iput-object p2, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->c:Lcom/uzmap/pkg/uzkit/fineHttp/RequestListener;

    iput-object p1, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->b:Lcom/uzmap/pkg/uzkit/request/Request;

    instance-of p1, p2, Lcom/uzmap/pkg/uzkit/fineHttp/ProgressListener;

    iput-boolean p1, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->d:Z
    ...
    iput-object p1, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->a:Lorg/json/JSONObject;

    :cond_0
    return-void
.end method

.method private progressDone(Lcom/uzmap/pkg/uzkit/request/HttpResult;)V
    .locals 5

    iget-boolean v0, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->d:Z
    ...
    iget-object v0, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->b:Lcom/uzmap/pkg/uzkit/request/Request;

    invoke-static {v0, p1}, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils;->transError(Lcom/uzmap/pkg/uzkit/request/Request;Lcom/uzmap/pkg/uzkit/request/HttpResult;)Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$ErrorInfo;
    ...
    :goto_0
    :try_start_1
    iget-object v2, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->a:Lorg/json/JSONObject;
    ...
    iget-object v0, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->a:Lorg/json/JSONObject;
    ...
    :goto_1
    iget-object p1, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->c:Lcom/uzmap/pkg/uzkit/fineHttp/RequestListener;
...
.method final activeObserver()Z
    ...
    iget-object v0, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->c:Lcom/uzmap/pkg/uzkit/fineHttp/RequestListener;
...
.method public onEventSourceClose()V
    ...
    invoke-virtual {p0}, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->activeObserver()Z
...
.method public onFinish(Lcom/uzmap/pkg/uzkit/request/HttpResult;)V
    ...
    iget-object v1, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->c:Lcom/uzmap/pkg/uzkit/fineHttp/RequestListener;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->progressDone(Lcom/uzmap/pkg/uzkit/request/HttpResult;)V
...
.method public onProgress(JD)V
    ...
    iget-object p1, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->b:Lcom/uzmap/pkg/uzkit/request/Request;
    ...
    iget-boolean p1, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->d:Z
    ...
    :try_start_0
    iget-object p2, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->a:Lorg/json/JSONObject;
    ...
    :goto_0
    iget-object p2, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->c:Lcom/uzmap/pkg/uzkit/fineHttp/RequestListener;

    check-cast p2, Lcom/uzmap/pkg/uzkit/fineHttp/ProgressListener;

    iget-object p3, p0, Lcom/uzmap/pkg/uzkit/request/FineHttpUtils$SubmitCallback;->a:Lorg/json/JSONObject;
