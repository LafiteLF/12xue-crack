.class public final Lcom/apicloud/glide/load/resource/bitmap/TransformationUtils;
...
.method public static centerCrop(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    ...
    .line 62
    :cond_3
    invoke-static {p1}, Lcom/apicloud/glide/load/resource/bitmap/TransformationUtils;->getSafeConfig(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    .line 66
    :goto_1
    invoke-static {p1, p0}, Lcom/apicloud/glide/load/resource/bitmap/TransformationUtils;->setAlpha(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static fitCenter(Landroid/graphics/Bitmap;Lcom/apicloud/glide/load/engine/bitmap_recycle/BitmapPool;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    .line 109
    :cond_3
    invoke-static {p0}, Lcom/apicloud/glide/load/resource/bitmap/TransformationUtils;->getSafeConfig(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;

    move-result-object v5

    .line 110
    invoke-interface {p1, v3, v4, v5}, Lcom/apicloud/glide/load/engine/bitmap_recycle/BitmapPool;->get(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 115
    :cond_4
    invoke-static {p0, p1}, Lcom/apicloud/glide/load/resource/bitmap/TransformationUtils;->setAlpha(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V
...
.method public static getOrientation(Ljava/lang/String;)I
    ...
    .line 163
    invoke-static {v1}, Lcom/apicloud/glide/load/resource/bitmap/TransformationUtils;->getExifOrientationDegrees(I)I
...
.method public static orientImage(Ljava/lang/String;Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    .line 183
    invoke-static {p0}, Lcom/apicloud/glide/load/resource/bitmap/TransformationUtils;->getOrientation(Ljava/lang/String;)I

    move-result p0

    .line 184
    invoke-static {p1, p0}, Lcom/apicloud/glide/load/resource/bitmap/TransformationUtils;->rotateImage(Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
...
.method public static rotateImageExif(Landroid/graphics/Bitmap;Lcom/apicloud/glide/load/engine/bitmap_recycle/BitmapPool;I)Landroid/graphics/Bitmap;
    .locals 4
    ...
    .line 257
    invoke-static {p2, v0}, Lcom/apicloud/glide/load/resource/bitmap/TransformationUtils;->initializeMatrixForRotation(ILandroid/graphics/Matrix;)V
    ...
    .line 270
    invoke-interface {p1, v1, v2, v3}, Lcom/apicloud/glide/load/engine/bitmap_recycle/BitmapPool;->get(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
