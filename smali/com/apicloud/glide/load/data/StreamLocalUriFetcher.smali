.class public Lcom/apicloud/glide/load/data/StreamLocalUriFetcher;
.super Lcom/apicloud/glide/load/data/LocalUriFetcher;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "Lcom/apicloud/glide/load/data/LocalUriFetcher<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/apicloud/glide/load/data/StreamLocalUriFetcher;->URI_MATCHER:Landroid/content/UriMatcher;
    ...
    .line 40
    sget-object v0, Lcom/apicloud/glide/load/data/StreamLocalUriFetcher;->URI_MATCHER:Landroid/content/UriMatcher;
...
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 47
    invoke-direct {p0, p1, p2}, Lcom/apicloud/glide/load/data/LocalUriFetcher;-><init>(Landroid/content/Context;Landroid/net/Uri;)V
...
.method private loadResourceFromUri(Landroid/net/Uri;Landroid/content/ContentResolver;I)Ljava/io/InputStream;
    ...
    :cond_2
    :goto_0
    invoke-direct {p0, p2, p1}, Lcom/apicloud/glide/load/data/StreamLocalUriFetcher;->openContactPhotoInputStream(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/io/InputStream;
...
.method protected bridge synthetic close(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/apicloud/glide/load/data/StreamLocalUriFetcher;->close(Ljava/io/InputStream;)V
...
.method protected loadResource(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
    ...
    .line 53
    invoke-direct {p0, p1, p2, v0}, Lcom/apicloud/glide/load/data/StreamLocalUriFetcher;->loadResourceFromUri(Landroid/net/Uri;Landroid/content/ContentResolver;I)Ljava/io/InputStream;
...
.method protected bridge synthetic loadResource(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/lang/Object;
    ...
    .line 21
    invoke-virtual {p0, p1, p2}, Lcom/apicloud/glide/load/data/StreamLocalUriFetcher;->loadResource(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
