...
.method constructor <init>(JLandroid/support/v8/renderscript/RenderScript;Landroid/support/v8/renderscript/Type;I)V
    ...
    .line 71
    iput-boolean p1, p0, Landroid/support/v8/renderscript/Allocation;->mReadAllowed:Z

    .line 72
    iput-boolean p1, p0, Landroid/support/v8/renderscript/Allocation;->mWriteAllowed:Z

    const/4 p2, 0x0

    .line 73
    iput-boolean p2, p0, Landroid/support/v8/renderscript/Allocation;->mAutoPadding:Z

    .line 77
    sget-object p3, Landroid/support/v8/renderscript/Type$CubemapFace;->POSITIVE_X:Landroid/support/v8/renderscript/Type$CubemapFace;

    iput-object p3, p0, Landroid/support/v8/renderscript/Allocation;->mSelectedFace:Landroid/support/v8/renderscript/Type$CubemapFace;
    ...
    .line 318
    iput-boolean p2, p0, Landroid/support/v8/renderscript/Allocation;->mWriteAllowed:Z
    ...
    .line 330
    iput-boolean p2, p0, Landroid/support/v8/renderscript/Allocation;->mIncAllocDestroyed:Z
    ...
    iget-object p5, p0, Landroid/support/v8/renderscript/Allocation;->mType:Landroid/support/v8/renderscript/Type;

    invoke-virtual {p5}, Landroid/support/v8/renderscript/Type;->getElement()Landroid/support/v8/renderscript/Element;

    move-result-object p5

    invoke-virtual {p5}, Landroid/support/v8/renderscript/Element;->getBytesSize()I

    move-result p5

    mul-int/2addr p3, p5

    iput p3, p0, Landroid/support/v8/renderscript/Allocation;->mSize:I
    ...
    .line 339
    :cond_2
    sget-boolean p3, Landroid/support/v8/renderscript/RenderScript;->sUseGCHooks:Z

    if-ne p3, p1, :cond_3

    .line 341
    :try_start_0
    sget-object p3, Landroid/support/v8/renderscript/RenderScript;->registerNativeAllocation:Ljava/lang/reflect/Method;

    sget-object p4, Landroid/support/v8/renderscript/RenderScript;->sRuntime:Ljava/lang/Object;

    new-array p1, p1, [Ljava/lang/Object;

    iget p5, p0, Landroid/support/v8/renderscript/Allocation;->mSize:I
